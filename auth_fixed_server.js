...
// Users with correct password hashes for "123456" and "a1e2y3t4h5"
const users = [
    {
        id: 1,
        username: "admin",
    ...
    },
    {
        id: 2,
        username: "superadmin",
        password: "$2b$10$HKS8Z9s7qFqB5jGvQf0XC.xQc7wGjO5r8vK1mN3pL7qS2tU4vW6xO", // a1e2y3t4h5
        role: "superadmin",
        name: "Super Admin",
...
// Generate cartelas data (75 per shop)
const cartelas = [];
shops.forEach(shop => {
    for (let i = 1; i <= 75; i++) {
        cartelas.push({
...
app.get('/api/health', (req, res) => {
    res.json({
        status: "OK",
        version: "Authentication Fixed Server - July 24, 2025",
        hostname: "aradabingo",
...
app.listen(PORT, '0.0.0.0', () => {
    console.log(`🚀 Authentication-Fixed BingoMaster server running on port ${PORT}`);
